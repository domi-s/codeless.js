...
var alertstyle = "anote, aalert { border-left: 2px solid rgba(0, 0, 0, .2); width: 75%; } acode { width: calc(100% - 2 * 10px); } anote, aalert, acode { padding: 5px; display: inline-block; margin: 3px 0; } anote { background: lightyellow; } anote::before { content: 'Note: '; display: initial; font-family: Consolas; font-weight: bold; } aalert { background: salmon; } aalert::before { content: 'ALERT: '; display: initial; font-family: Consolas; font-weight: bold; } acode { background: #eee; border-radius: 5px; font-family: Consolas; }";
